$(function()
 {
    ...
    $(document).ready(function()
    {
        ...
        $("#title").keyup(function(){
           if(emptytitle()){
                ...
                $("#titleMeg").html("<p class='text-success par'><i class='fa fa-check'></i> </p>");
                
            }else{
                $("#title").css("border","1px solid #c0392b");
                $("#titleMeg").html("<p class='text-danger par'><i class='fa fa-exclamation-circle'></i></p>");
            }
        });
   ...
   $('.showf').click(function(){
    ...
    function emptytitle(){var title=$("#title").val();if(title.length > 10){return true;}else{return false;}}
...
//////////////////////////////////////////////////////////////////////Department conditions //////////////////////////////////////
    ...
    // Exchange class active(color red) in Display
    $('.option span').click(function(){
        $(this).addClass('active').siblings('span').removeClass('active');
        if($(this).data('view') === 'full'){
            $('.condition .full-view').fadeIn(200);
        }else{
            $('.condition .full-view').fadeOut(200);
        }
    });
